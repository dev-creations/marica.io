...
function Calendar({
  ...
  return (
    <DayPicker
      className={cn("p-3 dark:text-slate-100", className)}
      classNames={{
        ...
        day_selected:
          "bg-slate-900 text-slate-50 hover:bg-slate-900 hover:text-slate-50 focus:bg-slate-900 focus:text-slate-50 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-50 dark:hover:text-slate-200 dark:focus:bg-slate-50 dark:focus:text-slate-900",
