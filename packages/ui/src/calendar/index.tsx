  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "mio-bg-slate-900 mio-text-slate-50 hover:mio-bg-slate-900 hover:mio-text-slate-50 focus:mio-bg-slate-900 focus:mio-text-slate-50",
        day_today: "mio-bg-slate-100",
        day_outside:
          "day-outside mio-text-slate-500 mio-opacity-50 aria-selected:mio-bg-slate-100/50 aria-selected:mio-text-slate-500 aria-selected:mio-opacity-30",
        day_disabled: "mio-text-slate-500 mio-opacity-50",
        day_range_middle:
          "aria-selected:mio-bg-slate-100 aria-selected:mio-text-slate-900",
