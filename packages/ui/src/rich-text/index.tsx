  ...
  return (
    <div className="mio:shadow-md mio:mb-8 mio:flex mio:items-center mio:rounded-md mio:bg-white mio:p-2">
      <button
        ...
        className="mio:flex mio:items-center mio:justify-center mio:hover:bg-grey-7 mio:focus:outline-gray-400 mio:data-[active='true']:bg-gray-400 mio:data-[active='true']:text-gray-700 mio:size-8 mio:focus:outline mio:[font-variant:small-caps]"
      >
...
function RichText({
  ...
  return (
    <>
      ...
      <EditorContent
        className="mio:*:shadow-md mio:*:focus-within:outline-gray-400 mio:*:max-h-[200px] mio:*:min-h-[100px] mio:*:w-full mio:*:min-w-[200px] mio:*:max-w-full mio:*:overflow-y-scroll mio:*:rounded-md mio:*:bg-white mio:*:focus-within:outline mio:[&>div]:p-4 mio:**:outline-hidden"
        editor={editor}
      />
